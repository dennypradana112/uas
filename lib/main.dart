...
import 'nama lengkap.dart';
import 'TL.dart';
import 'hobby.dart';
import 'cita-cita.dart';
import 'alamat.dart';
...
class UserProfilePage extends StatelessWidget {
  final String _fullName = "Denny Pradana";
  final String _status = "Pebisnis";
  final String _bio = "";
          ...
          children: <Widget>[
              ...
              child: InkWell(
                onTap: () => {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const namalengkap()))
                },
                child: Container(
                  height: 40.0,
                  decoration: BoxDecoration(
                    border: Border.all(),
                    color: Color.fromARGB(255, 11, 191, 251),
                  ),
                  child: Center(
                    child: Text(
                      "Nama Lengkap",
              ...
              child: InkWell(
                onTap: () => {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => const TL()))
                },
                child: Container(
                  height: 40.0,
                  decoration: BoxDecoration(
            ...
            Card(
              ...
              child: InkWell(
                onTap: () => {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => const citacita()))
                },
                child: Container(
                  height: 40.0,
                  decoration: BoxDecoration(
